...
class Workspace:
    ...
    def eval_meta(self, meta):
        step, episode, total_reward = 0, 0, 0
        eval_until_episode = utils.Until(self.cfg.num_eval_episodes)
        meta = self.agent.select_meta(meta)
...
@hydra.main(config_path='.', config_name='extract_skill_aspect')
def main(cfg):
    from extract_skill_aspect import Workspace as W
    root_dir = Path.cwd()
